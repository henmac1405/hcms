...
class _LoginPageState extends State<LoginPage> {
                      ...
                      children: <Widget>[
                              ...
                              child: ElevatedButton(
                                ...
                                onPressed: () {
                                  ...
                                  if (NIK == "123123123") {
                                    ...
                                    _showDialogDownload();
                                  } else if (NIK == "debug on local") {
                                    setState(() {
                                      _strController.text = url_api_dev;
                                    });
                                    _showDialogDebug();
                                ...
                                child: const Text(
                                    'LOGIN'), // The text label for the button
                              ),
                            ),
                          ]),
                        ),
                        ...
                        SizedBox(
                          ...
                          child: ElevatedButton.icon(
                            ...
                            label: const Text(
                                'Petunjuk : Pilih Company, masukkan NIK dan Password untuk masuk ke menu Utama'), // The text label for the button
                          ),
                        ),
                        const SizedBox(
                          height: 20,
  ...
  void _navigateToDistance(BuildContext context) {
    Route route = MaterialPageRoute<void>(
        builder: (context) => RadiusPage(
      ...
      if (hasils.isNotEmpty) {
        ...
        fh.token(apikey, url_api).then((hasils) {
          ...
          if (hasils.isNotEmpty) {
            ...
            //     .then((resultdate) {
            //   print(resultdate);
            if (NIK == "distance" || NIK == "jarak") {
              hideLoadingDialog(context);
              _navigateToDistance(context);
            } else {
