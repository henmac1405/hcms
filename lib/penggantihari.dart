        ...
        ListTile(
          ...
          trailing: IconButton(
              ...
              onPressed: () {
                ...
                //   context: context,
                //   isScrollControlled:
                //       true, // Mengizinkan tinggi modal menyesuaikan konten gambar besar
                //   backgroundColor: Colors
                //       .transparent, // Membuat latar belakang sheet luar tembus pandang
                //   builder: (context) => Container(
                //     // Jarak margin dari tepi layar HP (kiri, kanan, bawah) agar melayang rapi
                //     margin:
                //         const EdgeInsets.only(left: 20, right: 20, bottom: 20),
                //     child: Column(
                //       mainAxisSize: MainAxisSize
                //           .min, // Membuat tinggi kontainer pas dengan isi gambar
                //       children: [
                ...
                //                 .size
                //                 .width, // Mengambil lebar maksimal kontainer margin
                //             fit: BoxFit.contain,
                //             errorBuilder: (context, error, stackTrace) {
                //               return Container(
                //                 padding: const EdgeInsets.all(20),
                //                 color: Colors
                //                     .white, // Ditambahkan background putih agar ikon error terlihat jelas
                //                 child: const Icon(
